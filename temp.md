...
### Для того что бы участвовать в чужом проекте необходимо:
* В своём аккаунте на GitHub создать копию репозитория чужого проекта с помощью кнопки **"Fork"**.
---
* Клонировать копию репозитория на локальный компьютер.
---
* Создать новую ветку.
---
* Добавить изменения в новую ветку.
---
